...
if [[ $(uname) = 'Darwin' ]]; then
    ...
    if which -s brew; then
        ...
        for formula in ack autojump bash bash-completion links irssi mercurial nethack proxytunnel python python python source-highlight tinyproxy unnethack unrar vim vim watch wget wget python; do
